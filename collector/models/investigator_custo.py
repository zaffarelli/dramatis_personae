...
class InvestigatorCusto(models.Model):
    class Meta:
        verbose_name = "COC7: Investigator Customization"
    from collector.models.investigator import Investigator
    investigator = models.OneToOneField(Investigator, on_delete=models.CASCADE, primary_key=True)
