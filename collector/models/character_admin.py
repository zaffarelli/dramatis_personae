...
class CharacterAdmin(admin.ModelAdmin):
    list_display = ('full_name','alias', 'rid','importance','entrance','specie','alliance','is_dead','lifepath_total','OP','use_history_creation','is_public','is_partial','use_only_entrance','is_visible','epic')
    inlines = [
        SkillInline,
        BlessingCurseInline,
