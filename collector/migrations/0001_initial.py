# Generated by Django 2.2.7 on 2019-11-23 00:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reference', models.CharField(blank=True, default='', max_length=64)),
                ('category', models.CharField(blank=True, choices=[('Upbringing', 'Upbringing'), ('Apprenticeship', 'Apprenticeship'), ('Early Career', 'Early Career'), ('Tour of Duty', 'Tour of Duty'), ('Full Tour of Duty', 'Full Tour of Duty')], default='Soft', max_length=20)),
                ('AP', models.IntegerField(default=0)),
                ('OP', models.IntegerField(default=0)),
