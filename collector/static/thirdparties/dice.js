...
(function(dice) {
  ...
  this.create_d6_geometry = function(radius) {
    ...
    return create_geom(vertices, faces, radius*1.5, 0.1, Math.PI / 4, 0.96);
  }
  ...
  this.create_d12_geometry = function(radius) {
    ...
    return create_geom(vertices, faces, radius*2, 0.2, -Math.PI / 4 / 2, 0.968);
  }
  ...
  this.label_color = '#101010';
  this.dice_color = '#806010';
  ...
  this.dice_box = function(container, dimentions) {
    ...
    this.renderer.setClearColor(0xff202020, 1);
