...
urlpatterns = [
    ...
    re_path('^ajax/cards/(?P<ref>\d+)/$', handle_cards, name='handle_cards'),
    re_path('^ajax/collections/$', handle_collections, name='handle_collections'),
    ...
    re_path('^ajax/switcher/(?P<option>[\w+]+)/(?P<slug>[\w+]+)/(?P<id>\d+)/$', deep_toggle, name='deep_toggle'),
