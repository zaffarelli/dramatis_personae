...
python manage.py dumpdata collector.TalentRef --format xml --output backup/reference/talent_ref.xml
...
python manage.py dumpdata collector.ShipSystem --format xml --output backup/custom/ship_system.xml
python manage.py dumpdata collector.ShipSection --format xml --output backup/custom/ship_section.xml
python manage.py dumpdata collector.ShipRef --format xml --output backup/custom/ship_ref.xml
...
python manage.py dumpdata collector.Talent --format xml --output backup/custom/talent.xml
