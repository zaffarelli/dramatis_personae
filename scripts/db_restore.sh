...
python manage.py loaddata backup/reference/$1/ship_section.xml
...
#python manage.py loaddata backup/reference/$1/coc7_occupation.xml
#python manage.py loaddata backup/custom/$1/investigator.xml
