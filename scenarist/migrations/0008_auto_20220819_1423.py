# Generated by Django 2.2 on 2022-08-19 14:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='adventure',
            name='total_challenge',
            field=models.PositiveIntegerField(default=0),
        ),
        migrations.AddField(
            model_name='backlog',
            name='category',
            field=models.CharField(choices=[('NC', 'Non Categorized'), ('FA', 'Factions'), ('OC', 'Occult'), ('TK', 'Technology'), ('SP', 'Spaceships'), ('CO', 'Combat')], default='NC', max_length=2),
        ),
        migrations.AddField(
            model_name='backlog',
            name='reference',
