...
from scenarist.views.dramas import DramaDetailView, DramaUpdateView
from scenarist.views.acts import ActDetailView, ActUpdateView
from scenarist.views.events import EventDetailView, EventUpdateView
