    ...
    while num_tier > 0:
        ...
        for i,v in enumerate(fencers):
            if i%2==0:
                ...
                tier_results['duels'].append({'duel_id':f'ITDxT{int(num_tier)}xD{num_duel}x','tori':tori,'uke':uke,'tori_color':tori_color,'uke_color':uke_color,'winner':winner,'scores':stats})
                del duel
